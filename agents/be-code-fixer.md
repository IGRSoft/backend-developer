...
|-------|------|-------------|
| **DR** | Primary Support | Apply `corpflow:technical-lead` findings from `.context/developer-review-N.md`; enforce minimal-diff; write retries to `.context/errors/be-code-fixer.md` |
