...
| **workflow-integration** | [_shared/workflow-integration/SKILL.md](_shared/workflow-integration/SKILL.md) | Integrating with the corpflow 11-stage pipeline (v4.0.13) — DV/DR/QA artifact format and evidence gate |
