...
Copy this to `.context/development-N.md` (`N` from `task.metadata.run_index`; e.g. `development-0.md`). H2 anchors are fixed by company-workflow's anchor allow-list — keep them exactly as written (kebab-case, H2); backend sections nest as H3.
