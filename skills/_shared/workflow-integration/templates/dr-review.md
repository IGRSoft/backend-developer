...
Primary artifact `.context/developer-review-N.md` is owned by igrsoft's technical-lead; use this when a backend-developer agent takes over DR or contributes the review body. be-code-fixer appends retry narratives to `.context/errors/be-code-fixer.md` instead.
