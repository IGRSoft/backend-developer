...
| `migrations/SKILL.md` | Expand-contract / zero-downtime, reversibility, backfills, online DDL and locking pitfalls |
...
| `caching-strategies/SKILL.md` | Redis cache-aside/write-through, invalidation, TTL/eviction, distributed locks, idempotency stores, rate-limit counters, hot keys |
